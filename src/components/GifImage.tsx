...
const GifImage = ({
  ...
  return (
    <motion.div
      ...
      className="img_container relative "
      onMouseEnter={() => {
        setHovered(true);
      }}
      onMouseLeave={() => {
    ...
    >
      ...
      <motion.div
        ...
        className="hover_share absolute w-full h-full bg-black bg-opacity-40 rounded-md z-10 flex flex-col items-center justify-center gap-2"
      >
        <div
